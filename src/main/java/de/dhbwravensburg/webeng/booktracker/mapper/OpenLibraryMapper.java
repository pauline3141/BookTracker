...
public final class OpenLibraryMapper {
    ...
    public static BookResponse toResponse(OpenLibrarySubjectWork work) {
        String author = (work.authors() != null && !work.authors().isEmpty())
                ? work.authors().get(0).name()
                : "Unknown";
        String coverUrl = work.coverId() != null
        ...
        return new BookResponse(
                ...
                null,
                coverUrl,
                work.firstPublishYear() != null ? work.firstPublishYear() : 0,
                0
        );
    }
}